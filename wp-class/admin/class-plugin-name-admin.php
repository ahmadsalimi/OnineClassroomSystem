...
class Wp_Class_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $wp_class       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->wp_class, plugin_dir_url( __FILE__ ) . 'css/wp-class-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->wp_class, plugin_dir_url( __FILE__ ) . 'js/wp-class-admin.js', array( 'jquery' ), $this->version, false );
